...
```
    ...
    div.stNumberInput > div > div > input {{
        background-color: #FFEB3B !important;  /* Yellow box */
        color: #000000 !important;            /* Black text */
        border: 2px solid #F57F17 !important; /* Orange border */
        border-radius: 8px !important;
        padding: 10px !important;
        font-weight: bold;
    }}

    /* Style number input labels */
...
set_bg_local("/mnt/data/1021cf4e-9166-487b-8126-4ffeb50c380f.png")  # Updated with uploaded file
...
st.markdown(
""" <h1 style='text-align: center; color: #FFD700; text-shadow: 2px 2px 4px #000000;'>⚡ CEPALCO Electricity Bill Predictor ⚡</h1> <p style='text-align: center; font-size:16px; text-shadow: 1px 1px 2px #000000;'>Estimate your monthly electricity bill based on usage and appliances.</p>
""",
unsafe_allow_html=True
)
